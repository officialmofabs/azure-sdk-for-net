...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchSupportedImage
    {
        ...
        internal BatchSupportedImage(string nodeAgentSkuId, BatchImageReference imageReference, OSType osType, ImageVerificationType verificationType)
        {
        ...
        internal BatchSupportedImage(string nodeAgentSkuId, BatchImageReference imageReference, OSType osType, IReadOnlyList<string> capabilities, DateTimeOffset? batchSupportEndOfLife, ImageVerificationType verificationType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NodeAgentSkuId = nodeAgentSkuId;
            ImageReference = imageReference;
            OsType = osType;
        ...
        public BatchImageReference ImageReference { get; }
